...
```python
mysql -uroot -p123456 --default-character-set=utf8 < test.sql
```
...
```sql
set global slave_parrallel_type='LOGICAL_CLOCK';
...
cp /usr/local/keepalived/conf/keepalived.conf /etc/keepalived
